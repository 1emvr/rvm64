			...
			case stype: 
				{
					...
					switch(opcode7) {
						case 0b0100011: 
							{
								switch(func3) {
									case 0b000: scr_write(int32_t, imm, imm_s(opcode)); unwrap_opcall(_rv_sb); break;
									case 0b001: scr_write(int32_t, imm, imm_s(opcode)); unwrap_opcall(_rv_sh); break;
									case 0b010: scr_write(int32_t, imm, imm_s(opcode)); unwrap_opcall(_rv_sw); break;
									case 0b011: scr_write(int32_t, imm, imm_s(opcode)); unwrap_opcall(_rv_sd); break;
								}
							}
						case 0b0100111: 
							{
